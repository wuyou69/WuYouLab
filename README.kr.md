...
## 🚀 원클릭 설치
```bash
bash <(curl -sL https://raw.githubusercontent.com/wuyou69/WuYouLab/main/WuYouLab.sh) kr
```
***
...
## 스타 역사
[![별 역사 차트](https://api.star-history.com/svg?repos=WuYouLab/sh&type=Date)](https://star-history.com/#WuYouLab/sh&Date)
