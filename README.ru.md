...
<h1 style="font-size:150px;">WUYOULAB.SH - инструмент для создания скриптов WuYouLab с одним ключом</h1>
</div>
...
```bash
bash <(curl -sL sh.wuyou69.top) ru
```
<br><br>
...
## ⭐ Звездные тренды
[![Таблица истории звезд](https://api.star-history.com/svg?repos=WuYouLab/sh&type=Date)](https://star-history.com/#WuYouLab/sh&Date)
