...
<h1 style="font-size:150px;">WUYOULAB.SH - инструмент для создания скриптов Technology Lion с одним ключом</h1>
</div>
...
```bash
bash <(curl -sL https://raw.githubusercontent.com/wuyou69/WuYouLab/main/WuYouLab.sh) ru
```
<br><br>
